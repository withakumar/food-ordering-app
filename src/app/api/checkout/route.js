...
const stripe = require('stripe')(process.env.FOA_STRIPE_SK);
...
export async function POST(req) {
  ...
  const stripeSession = await stripe.checkout.sessions.create({
    ...
    success_url: process.env.FOA_NEXTAUTH_URL + 'orders/' + orderDoc._id.toString() + '?clear-cart=1',
    cancel_url: process.env.FOA_NEXTAUTH_URL + 'cart?canceled=1',
